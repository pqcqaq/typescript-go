...
func supportedPrimitiveFunctionSet(functions []bingo.FirstSliceMIRFunction) bool {
	if len(functions) == 1 {
		return functions[0].Name == "add" || functions[0].Name == "choose" || functions[0].Name == "classify" || functions[0].Name == "compute" || functions[0].Name == "coalesce" || functions[0].Name == "coalesceAssign"
	}
