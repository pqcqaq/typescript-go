...
func testHIR(t *testing.T) bingo.HIRModule {
	...
	module := bingo.HIRModule{
		...
		Provenance: bingo.HIRProvenance{
			...
			CompilerBuildIdentity:               bingo.CompilerBuildIdentity{UpstreamCommit: strings.Repeat("3", 40), ForkCommit: strings.Repeat("4", 40), LoweringSchema: "bingo-hir-lowering-v7", LoweringHash: strings.Repeat("5", 64)},
