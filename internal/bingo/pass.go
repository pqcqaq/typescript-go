...
var canonicalPassSpecs = [...]PassSpec{
	...
	{ID: PassTypedHIR, InputSchema: "source-type-plan-v2", OutputSchema: "hir-v3", ReadsFacts: []string{"source-type-plan"}, WritesFacts: []string{"typed-hir", "effect-proof"}, PreservesEvaluationOrder: true},
	{ID: PassEvaluationOrder, InputSchema: "hir-v3", OutputSchema: "hir-v3", ReadsFacts: []string{"typed-hir"}, WritesFacts: []string{"evaluation-order"}, PreservesEvaluationOrder: true},
	{ID: PassSpecialization, InputSchema: "hir-v3", OutputSchema: "hir-v3", ReadsFacts: []string{"typed-hir", "type-arguments"}, WritesFacts: []string{"specialization-fixed-point"}, PreservesEvaluationOrder: true},
	{
		ID: PassVarianceAliasing, InputSchema: "hir-v3", OutputSchema: "hir-v3",
		ReadsFacts: []string{"specialization-fixed-point", "property-facts"}, WritesFacts: []string{"variance-proof", "conversion-plan"},
		WritesArtifacts:          []PassArtifactWrite{{Name: PassArtifactTypedHIR, Schema: "hir-v3", FromPrimary: true}},
		PreservesEvaluationOrder: true,
	},
	{
		ID: PassResolveTarget, InputSchema: "hir-v3", OutputSchema: "target-context-v1",
	...
	},
	{
		...
		ReadsArtifacts: []PassArtifactRequirement{
			{Name: PassArtifactTypedHIR, Schema: "hir-v3"},
			{Name: PassArtifactBuildPlan, Schema: "build-plan-v1"},
			{Name: PassArtifactRuntimeManifest, Schema: "runtime-manifest-v1"},
			{Name: PassArtifactToolchainManifest, Schema: "toolchain-manifest-v1"},
