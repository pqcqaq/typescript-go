...
var canonicalPassSpecs = [...]PassSpec{
	{ID: PassValidateSnapshot, InputSchema: "snapshot-v2", OutputSchema: "source-type-plan-v1", ReadsFacts: []string{"syntax", "types", "symbols", "signatures", "module-graph"}, WritesFacts: []string{"source-type-plan"}, PreservesEvaluationOrder: true},
	{ID: PassTypedHIR, InputSchema: "source-type-plan-v1", OutputSchema: "hir-v2", ReadsFacts: []string{"source-type-plan"}, WritesFacts: []string{"typed-hir", "effect-proof"}, PreservesEvaluationOrder: true},
	{ID: PassEvaluationOrder, InputSchema: "hir-v2", OutputSchema: "hir-v2", ReadsFacts: []string{"typed-hir"}, WritesFacts: []string{"evaluation-order"}, PreservesEvaluationOrder: true},
	{ID: PassSpecialization, InputSchema: "hir-v2", OutputSchema: "hir-v2", ReadsFacts: []string{"typed-hir", "type-arguments"}, WritesFacts: []string{"specialization-fixed-point"}, PreservesEvaluationOrder: true},
	{
		ID: PassVarianceAliasing, InputSchema: "hir-v2", OutputSchema: "hir-v2",
		ReadsFacts: []string{"specialization-fixed-point", "property-facts"}, WritesFacts: []string{"variance-proof", "conversion-plan"},
		WritesArtifacts:          []PassArtifactWrite{{Name: PassArtifactTypedHIR, Schema: "hir-v2", FromPrimary: true}},
		PreservesEvaluationOrder: true,
	},
	{
		ID: PassResolveTarget, InputSchema: "hir-v2", OutputSchema: "target-context-v1",
	...
	{
		ID: PassRepresentationPlan, InputSchema: "target-context-v1", OutputSchema: "rep-plan-v1",
